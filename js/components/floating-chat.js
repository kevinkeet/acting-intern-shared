...
const FloatingChat = {
    ...
    renderTriggerButtons() {
        ...
        btnContainer.innerHTML = `
            ...
            <button class="chat-trigger-btn dictate-trigger" onclick="if(typeof DictationWidget!=='undefined') DictationWidget.toggle()" title="Dictate — dual-pane voice with orders">
                <span class="trigger-icon">&#127908;</span>
